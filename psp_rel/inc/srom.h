...
23. April 2004:  memory type added for model independency
All rights reserved.
-------------------------------------------------------------------------*/
...
#define SROM_FPS(n)                                                  \
extern unsigned char far  _PR_##n##_S_;  /* segment start */            \
extern unsigned char far  _PR_##n##_E_;  /* segment end */              \
extern unsigned char far  _PR_##n##_L_;  /* segment len */              \
extern unsigned char far  _PR_##n##_T_;  /* segment target address */   \
extern unsigned char far  _PR_##n##_B_;  /* segment bank address */
